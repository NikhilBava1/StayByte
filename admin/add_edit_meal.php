...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($editing) {
        ...
        // Add new meal
        $sql = "INSERT INTO meals (meal_title, description, image_url, price, rating, meal_type, items_included, meal_address, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        $stmt = mysqli_prepare($conn, $sql);
        mysqli_stmt_bind_param($stmt, "ssssdssss", $meal_title, $description, $image_url, $price, $rating, $meal_type, $items_included, $meal_address, $status);
...
<head>
    ...
    <title><?php echo $editing ? 'Edit Meal' : 'Add Meal'; ?> - StayByte Admin</title>
</head>
<body>
