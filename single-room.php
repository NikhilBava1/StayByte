    ...
    ?>          
                ...
                <div class="hotale-page-wrapper" id="hotale-page-wrapper">
                    <div class="tourmaster-room-single-header-title-wrap" style="border-radius: 20px 20px 20px 20px; -moz-border-radius: 20px 20px 20px 20px; -webkit-border-radius: 20px 20px 20px 20px;">
                        ...
                        <div class="tourmaster-container"><h1 class="tourmaster-item-pdlr">Deluxe Suite Room</h1></div>
                    </div>
                                    ...
                                    <div class="gdlr-core-pbf-sidebar-content-inner">
                                                ...
                                                <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js">
                                                    <div class="gdlr-core-pbf-element">
                                                        <div class="gdlr-core-image-item gdlr-core-item-pdb gdlr-core-center-align gdlr-core-item-pdlr">
                                                            ...
                                                            >
                                                                <img
                                                                    src="upload/christopher-jolly-GqbU78bdJFM-unsplash-1150x490.jpg"
                                                                    alt=""
                                                                    width="1150"
                                                                    height="490"
                                                                    title="christopher-jolly-GqbU78bdJFM-unsplash"
                                                                />
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="gdlr-core-pbf-column gdlr-core-column-60 gdlr-core-column-first" id="gdlr-core-column-1">
                                            <div class="gdlr-core-pbf-column-content-margin gdlr-core-js" style="margin: 0px 0px 0px 0px; padding: 10px 0px 20px 0px;">
                                                ...
                                                <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js">
                                                    ...
                                                    <div class="gdlr-core-pbf-element">
                                                        <div class="gdlr-core-divider-item gdlr-core-divider-item-normal gdlr-core-item-pdlr gdlr-core-center-align"><div class="gdlr-core-divider-line gdlr-core-skin-divider"></div></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="gdlr-core-pbf-column gdlr-core-column-20 gdlr-core-column-first" id="gdlr-core-column-8">
                                            <div
                                                ...
                                                style="margin: 0px 10px 20px 20px; padding: 25px 0px 0px 10px; border-radius: 20px 20px 20px 20px; -moz-border-radius: 20px 20px 20px 20px; -webkit-border-radius: 20px 20px 20px 20px;"
                                            >
                                                <div
                                        ...
                                        <div class="gdlr-core-pbf-column gdlr-core-column-20" id="gdlr-core-column-9">
                                            <div
                                                class="gdlr-core-pbf-column-content-margin gdlr-core-js gdlr-core-move-up-with-shadow"
                                                style="margin: 0px 10px 20px 10px; padding: 25px 0px 0px 10px; border-radius: 20px 20px 20px 20px; -moz-border-radius: 20px 20px 20px 20px; -webkit-border-radius: 20px 20px 20px 20px;"
                                            >
                                                <div
                                                    class="gdlr-core-pbf-background-wrap"
                                                    style="
                                        ...
                                        <div class="gdlr-core-pbf-column gdlr-core-column-20" id="gdlr-core-column-10">
                                            <div
                                                class="gdlr-core-pbf-column-content-margin gdlr-core-js gdlr-core-move-up-with-shadow"
                                                style="margin: 0px 20px 20px 10px; padding: 25px 0px 0px 10px; border-radius: 20px 20px 20px 20px; -moz-border-radius: 20px 20px 20px 20px; -webkit-border-radius: 20px 20px 20px 20px;"
                                            >
                                                <div
                                                    class="gdlr-core-pbf-background-wrap"
                                                    style="
                                        ...
                                        <div class="tourmaster-room-booking-bar-wrap">
                                            ...
                                            <div class="tourmaster-room-booking-bar-content">
                                                ...
                                                <div class="tourmaster-room-enquiry-wrap" data-room-tab="enquiry">
                                                    <form
                                                        class="tourmaster-enquiry-form tourmaster-form-field tourmaster-room clearfix"
                                                ...
                                                <ul class="slides">
                                                    <li class="gdlr-core-gallery-list gdlr-core-item-mglr" style="margin-left: 5px; margin-right: 5px;">
                                                        <div class="gdlr-core-media-image" style="height: 500px;">
                                                            ...
                                                            >
                                                                <img
                                                                    src="upload/shutterstock_1298236804.jpg"
                                                                    alt=""
                                                                    width="2200"
                                                                    height="1467"
                                                    ...
                                                    <li class="gdlr-core-gallery-list gdlr-core-item-mglr" style="margin-left: 5px; margin-right: 5px;">
                                                        <div class="gdlr-core-media-image" style="height: 500px;">
                                                            <a
                                                                class="gdlr-core-lightgallery gdlr-core-js"
                                                                href="upload/single-room-gallery-img.jpg"
                                                                data-lightbox-group="gdlr-core-img-group-1"
                                                            >
                                                                <img
                                                                    src="upload/single-room-gallery-img.jpg"
                                                                    alt=""
                                                                    width="711"
                                                                    height="997"
                                                                    title="single-room-gallery-img"
                                                                />
                                                            </a>
                                                        </div>
                                                    </li>
                                                    <li class="gdlr-core-gallery-list gdlr-core-item-mglr" style="margin-left: 5px; margin-right: 5px;">
                                                        <div class="gdlr-core-media-image" style="height: 500px;">
                                                            ...
                                                            >
                                                                <img
                                                                    src="upload/shutterstock_324822821.jpg"
                                                                    alt=""
                                                                    width="1800"
                                                                    height="1200"
                                                                    title="shutterstock_324822821"
                                                                />
                                                            </a>
                                                        </div>
                                                    </li>
                                                    <li class="gdlr-core-gallery-list gdlr-core-item-mglr" style="margin-left: 5px; margin-right: 5px;">
                                                        <div class="gdlr-core-media-image" style="height: 500px;">
                                                            ...
                                                            >
                                                                <img
                                                                    src="upload/andrii-podilnyk-766487-unsplash-scaled.jpg"
                                                                    alt=""
                                                                    width="1984"
                                                                    height="2560"
                                                    ...
                                                    <li class="gdlr-core-gallery-list gdlr-core-item-mglr" style="margin-left: 5px; margin-right: 5px;">
                                                        <div class="gdlr-core-media-image" style="height: 500px;">
                                                            <a
                                                                class="gdlr-core-lightgallery gdlr-core-js"
                                                                href="upload/shutterstock_1354405256.jpg"
                                                                data-lightbox-group="gdlr-core-img-group-1"
                                                            >
                                                                <img
                                                                    src="upload/shutterstock_1354405256.jpg"
                                                                    alt=""
                                                                    width="2000"
                                                                    height="1334"
                                                                    title="shutterstock_1354405256"
                                                                />
                                                            </a>
                                                        </div>
                                                    </li>
                                                    <li class="gdlr-core-gallery-list gdlr-core-item-mglr" style="margin-left: 5px; margin-right: 5px;">
                                                        <div class="gdlr-core-media-image" style="height: 500px;">
                                                            ...
                                                            >
                                                                <img
                                                                    src="upload/jen-p-541467-unsplash-scaled.jpg"
                                                                    alt=""
                                                                    width="1920"
                                                                    height="2560"
                                                    ...
                                                    <li class="gdlr-core-gallery-list gdlr-core-item-mglr" style="margin-left: 5px; margin-right: 5px;">
                                                        <div class="gdlr-core-media-image" style="height: 500px;">
                                                            <a
                                                                class="gdlr-core-lightgallery gdlr-core-js"
                                                                href="upload/christopher-jolly-GqbU78bdJFM-unsplash-1.jpg"
                                                                data-lightbox-group="gdlr-core-img-group-1"
                                                            >
                                                                <img
                                                                    src="upload/christopher-jolly-GqbU78bdJFM-unsplash-1.jpg"
                                                                    alt=""
                                                                    width="2000"
                                                                    height="1333"
                                                                    title="christopher-jolly-GqbU78bdJFM-unsplash"
                                                            ...
                                                            <ul class="slides">
                                                                        ...
                                                                        <div class="tourmaster-room-grid-inner">
                                                                            <div class="tourmaster-room-thumbnail tourmaster-media-image tourmaster-with-price">
                                                                                ...
                                                                                <div class="tourmaster-price-wrap tourmaster-with-bg">
                                                                                    <span class="tourmaster-head">From</span><span class="tourmaster-price">CHF 86</span><span class="tourmaster-tail"> / night</span>
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <li class="gdlr-core-item-mglr">
                                                                    <div class="tourmaster-room-grid">
                                                                        <div class="tourmaster-room-grid-inner">
                                                                            <div class="tourmaster-room-thumbnail tourmaster-media-image tourmaster-with-price">
                                                                                <a href="https://demo.goodlayers.com/hotale/resort/room/standard-deluxe/">
                                                                                    <img
                                                                                ...
                                                                                <div class="tourmaster-price-wrap tourmaster-with-bg">
                                                                                    <span class="tourmaster-head">From</span><span class="tourmaster-price">CHF 72</span><span class="tourmaster-tail"> / night</span>
                                                                                </div>
                                                                            </div>
                                                                            <div class="tourmaster-room-content-wrap">
                                                                                <h3 class="tourmaster-room-title gdlr-core-skin-title" style="text-transform: none;">
                                                                                    <a href="https://demo.goodlayers.com/hotale/resort/room/standard-deluxe/">Standard Deluxe</a>
                                                                                </h3>
                                                                                <div class="tourmaster-info-wrap clearfix">
                                                                                ...
                                                                                <a class="tourmaster-read-more tourmaster-type-text" href="https://demo.goodlayers.com/hotale/resort/room/standard-deluxe/">
                                                                                    Book Now<i class="icon-arrow-right"></i>
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="tourmaster-room-grid">
                                                                        <div class="tourmaster-room-grid-inner">
                                                                            <div class="tourmaster-room-thumbnail tourmaster-media-image tourmaster-with-price tourmaster-with-ribbon">
                                                                                ...
                                                                                <div class="tourmaster-price-wrap tourmaster-with-bg">
                                                                                    <span class="tourmaster-head">From</span><span class="tourmaster-price-discount">CHF 240</span><span class="tourmaster-price">CHF 192</span>
                                                                    ...
                                                                    <div class="tourmaster-room-grid">
                                                                        <div class="tourmaster-room-grid-inner">
                                                                            <div class="tourmaster-room-thumbnail tourmaster-media-image tourmaster-with-price">
                                                                                ...
                                                                                <div class="tourmaster-price-wrap tourmaster-with-bg">
                                                                                    <span class="tourmaster-head">From</span><span class="tourmaster-price">CHF 77</span><span class="tourmaster-tail"> / night</span>
                                                                                </div>
                                                                            </div>
                                                                            <div class="tourmaster-room-content-wrap">
                                                                                <h3 class="tourmaster-room-title gdlr-core-skin-title" style="text-transform: none;">
                                                                    ...
                                                                    <div class="tourmaster-room-grid">
                                                                        <div class="tourmaster-room-grid-inner">
                                                                            <div class="tourmaster-room-thumbnail tourmaster-media-image tourmaster-with-price tourmaster-with-ribbon">
                                                                                ...
                                                                                <div class="tourmaster-price-wrap tourmaster-with-bg">
                                                                                    <span class="tourmaster-head">From</span><span class="tourmaster-price-discount">CHF 77</span><span class="tourmaster-price">CHF 66</span>
                                                                                    <span class="tourmaster-tail"> / night</span>
                                                                                </div>
                                                                    ...
                                                                    <div class="tourmaster-room-grid">
                                                                        <div class="tourmaster-room-grid-inner">
                                                                            <div class="tourmaster-room-thumbnail tourmaster-media-image tourmaster-with-price">
                                                                                ...
                                                                                <div class="tourmaster-price-wrap tourmaster-with-bg">
                                                                                    <span class="tourmaster-head">From</span><span class="tourmaster-price">CHF 173</span><span class="tourmaster-tail"> / night</span>
                                                                                </div>
                                                                            </div>
                                                                            <div class="tourmaster-room-content-wrap">
                                                                                <h3 class="tourmaster-room-title gdlr-core-skin-title" style="text-transform: none;">
                                    ...
                                    <div class="tourmaster-single-review-content-item clearfix">
                                        <div class="tourmaster-single-review-user clearfix">
                                            <div class="tourmaster-single-review-avatar tourmaster-media-image">
                                                <img
                                                    alt=""
                                                    src="https://secure.gravatar.com/avatar/03b9ebd1ab10d2362a586d5492188d1f?s=90&amp;d=mm&amp;r=g"
                                                    srcset="https://secure.gravatar.com/avatar/03b9ebd1ab10d2362a586d5492188d1f?s=180&#038;d=mm&#038;r=g 2x"
                                        ...
                                        <div class="tourmaster-single-review-detail">
                                            <div class="tourmaster-single-review-detail-description"><p>Very nice room!</p></div>
