...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_profile'])) {
    ...
    $stmt = mysqli_prepare($conn, $sql);
    mysqli_stmt_bind_param($stmt, "ssssi", $first_name, $last_name, $email, $phone, $provider_id);
    
    if (mysqli_stmt_execute($stmt)) {
        // Update session variables
        $_SESSION['provider_name'] = $first_name . ' ' . $last_name;
    ...
    if (password_verify($current_password, $provider['password'])) {
        ...
        if ($new_password === $confirm_password) {
            ...
            if (strlen($new_password) >= 6) {
                ...
                $stmt = mysqli_prepare($conn, $sql);
                mysqli_stmt_bind_param($stmt, "si", $hashed_password, $provider_id);
...
<head>
    ...
    <title>Provider Profile - StayByte</title>
    <style>
        :root {
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <div class="avatar-container me-3">
                                            <div class="avatar bg-primary text-white rounded-circle d-flex align-items-center justify-content-center" style="width: 50px; height: 50px; font-size: 1.2rem;">
                                                <?php echo substr(htmlspecialchars($provider['first_name']), 0, 1) . substr(htmlspecialchars($provider['last_name']), 0, 1); ?>
                                            </div>
                                        </div>
                                        <div>
                                            <h5 class="mb-0"><?php echo htmlspecialchars($provider['first_name'] . ' ' . $provider['last_name']); ?></h5>
                                ...
                                <form method="POST">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="first_name" name="first_name" value="<?php echo htmlspecialchars($provider['first_name']); ?>" required>
                                        </div>
                                        
                                        <div class="col-md-6 mb-3">
                                            <label for="last_name" class="form-label">Last Name</label>
                                            <input type="text" class="form-control" id="last_name" name="last_name" value="<?php echo htmlspecialchars($provider['last_name']); ?>" required>
                                        </div>
                                    </div>
                                    <!-- email -->
                                    <div class="mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="provider_id" value="<?php echo htmlspecialchars($provider['user_id']); ?>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="role" value="Provider" readonly>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <div class="text-center p-3 bg-light rounded">
                                            ...
                                            <p class="mb-0 text-muted"><?php echo date('M j, Y', strtotime($provider['created_at'])); ?></p>
                                        </div>
                                    </div>
