...
if (isset($_GET['id'])) {
    ...
    // Fetch room details (only if it belongs to this provider)
    $sql = "SELECT * FROM rooms WHERE room_id = ? AND room_provider_id = ?";
    $stmt = mysqli_prepare($conn, $sql);
    mysqli_stmt_bind_param($stmt, "ii", $room_id, $provider_id);
    ...
    if ($room = mysqli_fetch_assoc($result)) {
        ...
        $status = $room['status'];
        $room_provider_id = $room['room_provider_id'];
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="hidden" name="room_provider_id" value="<?php echo $provider_id; ?>">
                            </div>
